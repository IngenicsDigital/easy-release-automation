"""Shell-Modification Plugin

Description:
    Shell-Modification that executes shell-commands for modification.
...
class ShellModificationPlugin(ModificationInterface):
    ...
    def __init__(
        ...
        """Initializes the ShellModificationPlugin"""
    ...
    def _execute_shell_command(self, command: list[str]):
        ...
        Raises:
            ModificationException: if the bash command returns a non-zero value.
        """
